...
def main(_):
    ...
    #return
    pngName = 'imgs/smooth_plot.png'
    smooth_curves_plot.savefig(pngName)
    logger.info('writing imgs/smooth_plot.png')
    ...
    if FLAGS.interpolation:
        ...
        pngName = 'imgs/interpolate_{0}.png'.format(smooth_resamp)
        interpolate_curves_plot.savefig(pngName)
        logger.info('writing imgs/interpolate_plot.png')
